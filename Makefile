.PHONY: help init plan apply destroy fmt validate lint clean test examples docs security cost backup restore outputs resources import refresh show-plan show-state lock unlock validate-vars plan-vars apply-vars destroy-vars usage
...
help:
	...
	@echo "  restore     - Restore state"
	@echo "  outputs     - Show outputs"
	@echo "  resources   - Show resources"
	@echo "  import      - Import resource"
	@echo "  refresh     - Refresh state"
	@echo "  show-plan   - Show plan"
	@echo "  show-state  - Show state"
	@echo "  lock        - Lock state"
	@echo "  unlock      - Unlock state"
	@echo "  validate-vars - Validate variables"
	@echo "  plan-vars   - Plan with variables"
	@echo "  apply-vars  - Apply with variables"
	@echo "  destroy-vars - Destroy with variables"
...
usage:
	...
	@echo "module \"ec2\" {"
	@echo "  source = \"./tfm-aws-ec2/tfm-aws-ec2\""
